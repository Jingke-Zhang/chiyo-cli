...
class ToolConfigTests(unittest.TestCase):
    def test_load_chiyo_config_uses_infrastructure_defaults(self):
        ...
        self.assertEqual(config["enabled_tools"], ["shiori-route/go-or-pick", "shiori-route/web-search", "shiori-route/workspace"])
    ...
    def test_enable_tool_adds_command_once(self):
        ...
        self.assertEqual(
            ...
            ["shiori-route/go-or-pick", "shiori-route/web-search", "shiori-route/workspace", "paper"],
        )
