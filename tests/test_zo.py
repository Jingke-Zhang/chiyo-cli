...
from chiyo_cli.builtin_tools import zotero as ZO
...
class ZoteroTests(unittest.TestCase):
    ...
    @mock.patch("chiyo_cli.builtin_tools.zotero.local_api.urlopen")
    ...
    @mock.patch("chiyo_cli.builtin_tools.zotero.tool.open_location")
    ...
    @mock.patch("chiyo_cli.builtin_tools.zotero.attachments.urlopen")
    @mock.patch("chiyo_cli.builtin_tools.zotero.local_api.urlopen")
