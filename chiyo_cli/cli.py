...
from chiyo_cli.commands.doctor import (
    ...
    check_symlink,
    command_symlink_checks,
    completion_symlink_checks,
    config_module_checks,
    doctor,
    doctor_lines,
    init_zsh,
    print_init,
    user_tool_doctor_checks,
    zshrc_path,
)
from chiyo_cli.commands.install import (
    assert_install_targets_are_safe,
    completion_path,
    completion_script,
    helper_path,
    install_resolved_tool_lines,
    install_tool_lines,
    install_tools_lines,
    ...
    shell_function_script,
    shell_path,
    uninstall_tool_lines,
    uninstall_tools_lines,
    wrapper_path,
    wrapper_script,
    write_completion,
    write_shell_artifact,
    write_wrapper,
)
...
def parse_args(argv):
    parser = argparse.ArgumentParser(
        description="Manage Chiyo CLI shell integration and diagnostics. Run without a subcommand to show the dashboard.",
    )
